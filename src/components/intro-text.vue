...
const topText = ref(["Product Description", "Reviews"]);
...
<template>
  <div class="container flex flex-wrap py-8 md:p-15 mt-[94px]">
    <div class="flex gap-[30px]">
      <h3
        class="text-[#3D3D3D] text-[17px] hover:text-[#46A358] border-b-transparent border-b-[3px] hover:border-b-[#46A358] duration-200"
